...
public class ClienteAPI {
	...
	public ResponseEntity<ClienteDTO> cadastrarCliente(@RequestBody ClienteDTO clienteDTO) {
		...
		List<String> listaLinks = Arrays.asList(CONSULTAR_CLIENTE_NOME, CONSULTAR_CLIENTE_ID, REMOVER_CLIENTE_ID,
				                                ATUALIZAR_CLIENTE_NOME, CONSULTAR_CLIENTES);
	...
	public ResponseEntity<List<ClienteDTO>> consultarClienteNome(@RequestParam(value = "nomeCompleto") String nome) {
		...
		List<String> listaLinks = Arrays.asList(CADASTRAR_CLIENTE, CONSULTAR_CLIENTE_ID, REMOVER_CLIENTE_ID,
				                                ATUALIZAR_CLIENTE_NOME, CONSULTAR_CLIENTES);
	...
	public ResponseEntity<ClienteDTO> consultarClienteId(@PathVariable(value = "id") Long id) {
		...
		List<String> listaLinks = Arrays.asList(CADASTRAR_CLIENTE, CONSULTAR_CLIENTE_NOME, REMOVER_CLIENTE_ID,
				                                ATUALIZAR_CLIENTE_NOME, CONSULTAR_CLIENTES);
	...
	public ResponseEntity<ClienteDTO> atualizarClienteNome(@PathVariable("id") long id,
		...
		if (clienteDTO != null) {
			...
			List<String> listaLinks = Arrays.asList(CADASTRAR_CLIENTE, CONSULTAR_CLIENTE_NOME, CONSULTAR_CLIENTE_ID,
					                                REMOVER_CLIENTE_ID, CONSULTAR_CLIENTES);
			clienteDTO = gerarLink(clienteDTO, listaLinks);
	...
	public ResponseEntity<List<ClienteDTO>> consultarClientes() {
		...
		List<String> listaLinks = Arrays.asList(CADASTRAR_CLIENTE, CONSULTAR_CLIENTE_NOME, CONSULTAR_CLIENTE_ID,
				                                REMOVER_CLIENTE_ID, ATUALIZAR_CLIENTE_NOME);
		listaClientesDTO = gerarListaLinks(listaClientesDTO, listaLinks);
	...
	private ClienteDTO gerarLink(ClienteDTO clienteDTO, List<String> listaLinks) {
		...
		for (String link : listaLinks) {
			...
			case CADASTRAR_CLIENTE:
				clienteDTO.add(linkTo(methodOn(ClienteAPI.class).cadastrarCliente(new ClienteDTO()))
						      .withRel(CADASTRAR_CLIENTE));
				break;
			case CONSULTAR_CLIENTE_NOME:
				clienteDTO.add(linkTo(methodOn(ClienteAPI.class).consultarClienteNome(clienteDTO.getNomeCompleto()))
						      .withRel(CONSULTAR_CLIENTE_NOME));
				break;
			case CONSULTAR_CLIENTE_ID:
				clienteDTO.add(linkTo(methodOn(ClienteAPI.class).consultarClienteId(clienteDTO.getId()))
						      .withRel(CONSULTAR_CLIENTE_ID));
				break;
			case REMOVER_CLIENTE_ID:
				clienteDTO.add(linkTo(methodOn(ClienteAPI.class).removerClienteId(clienteDTO.getId()))
						      .withRel(REMOVER_CLIENTE_ID));
				break;
			case ATUALIZAR_CLIENTE_NOME:
				clienteDTO.add(linkTo(methodOn(ClienteAPI.class).atualizarClienteNome(clienteDTO.getId(), clienteDTO))
						      .withRel(ATUALIZAR_CLIENTE_NOME));
				break;
