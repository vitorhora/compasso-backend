...
public class ClienteBusiness {
	...
	public ClienteDTO salvar(ClienteDTO clienteDTO) {
		...
		Cidade cidade = new Cidade(clienteDTO.getCidadeResidente().getId(),
				                   clienteDTO.getCidadeResidente().getNome(),
				                   clienteDTO.getCidadeResidente().getEstado());

		Cliente cliente = clienteRepository.save(new Cliente(clienteDTO.getId(),
