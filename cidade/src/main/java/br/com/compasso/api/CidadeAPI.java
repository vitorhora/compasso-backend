	...
	private CidadeDTO gerarLink(CidadeDTO cidadeDTO, List<String> listaLinks) {
		...
		for (String link : listaLinks) {
			...
			case CADASTRAR_CIDADE:
				cidadeDTO.add(linkTo(methodOn(CidadeAPI.class).cadastrarCidade(new CidadeDTO())).withRel(CADASTRAR_CIDADE));
				break;
			case CONSULTAR_CIDADE_NOME:
				cidadeDTO.add(linkTo(methodOn(CidadeAPI.class).consultarCidadeNome(cidadeDTO.getNome())).withRel(CONSULTAR_CIDADE_NOME));
				break;
			case CONSULTAR_CIDADE_ESTADO:
				cidadeDTO.add(linkTo(methodOn(CidadeAPI.class).consultarCidadeEstado(cidadeDTO.getEstado())).withRel(CONSULTAR_CIDADE_ESTADO));
				break;
			case CONSULTAR_CIDADES:
				cidadeDTO.add(linkTo(methodOn(CidadeAPI.class).consultarCidades()).withRel(CONSULTAR_CIDADES));
				break;
